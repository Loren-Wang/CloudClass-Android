                        ...
                        try {
                            if (res.data != null && res.data.size() > 0) {
                                ...
                                AgoraEduCourseware courseware = new AgoraEduCourseware(
                                        wareRes.getResourceName(), wareRes.getResourceUuid(), wareRes.getExt(),
                                        scenePath, scenes, url, wareRes.getConversion());
    ...
    private void start() {
        ...
        try {
            ...
            AgoraEduLaunchConfig launchConfig = new AgoraEduLaunchConfig(
                    ...
                    roomType, rtmToken, startTime, duration, region, null, null, null,
            ...
            AgoraClassroomSDK.INSTANCE.launch(this, launchConfig, state -> {
